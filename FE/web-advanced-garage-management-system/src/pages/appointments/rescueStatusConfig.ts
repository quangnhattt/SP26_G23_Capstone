...
> = {
  ...
  TOWING_ARRIVED: { color: "#ea580c", bg: "#fff7ed", border: "#fdba74", labelKey: "rescueMgrStatusTowingArrived" },
  ...
  PAYMENT_SUBMITTED: { color: "#2563eb", bg: "#dbeafe", border: "#93c5fd", labelKey: "rescueMgrStatusPaymentSubmitted" },
...
export const rescueStatusConfig: Record<string, { labelKey: string; color: string; bg: string }> = {
  ...
  TOWING_ARRIVED: { labelKey: "rescueStatusTowingArrived", color: "#ea580c", bg: "#fff7ed" },
  ...
  PAYMENT_SUBMITTED: { labelKey: "rescueStatusPaymentSubmitted", color: "#2563eb", bg: "#dbeafe" },
