export default {
  ...
  rescueStatusPending: "Chờ kiểm tra",
  rescueStatusAccepted: "Đã chấp nhận",
  rescueStatusEvaluating: "Đang đánh giá",
  rescueStatusQuoteSent: "Đã gửi báo giá",
  rescueStatusCustomerApproved: "KH đồng ý",
  rescueStatusCustomerRejected: "KH từ chối",
  rescueStatusTechnicianDispatched: "Đã điều KTV",
  rescueStatusVehicleDispatched: "Đã điều xe cứu hộ",
  rescueStatusDiagnosing: "Đang chẩn đoán",
  rescueStatusRepairingOnSite: "Đang sửa tại chỗ",
  rescueStatusNeedTowing: "Cần kéo xe",
  rescueStatusTowingConfirmed: "KH đồng ý kéo xe",
  rescueStatusTowingRejected: "KH từ chối kéo xe",
  rescueStatusInvoiced: "Đã xuất hóa đơn",
  rescueStatusPaid: "Đã thanh toán",
