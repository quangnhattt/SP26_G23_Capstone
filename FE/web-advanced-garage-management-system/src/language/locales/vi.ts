export default {
  ...
  rescueIssueTitleLabel: "Tiêu đề yêu cầu",
  rescueIssueTitlePlaceholder: "VD: Xe chết máy giữa đường",
  rescueIssueDescLabel: "Mô tả chi tiết",
  rescueIssueDescPlaceholder: "Mô tả chi tiết tình trạng xe của bạn...",
  rescueSymptomLabel: "Triệu chứng (chọn nhiều nếu có)",
  rescueSymptomEngineDead: "Xe chết máy",
  rescueSymptomOutOfFuel: "Hết xăng/nhiên liệu",
  rescueSymptomFlatTire: "Nổ lốp/thủng lốp",
  rescueSymptomOverheat: "Động cơ quá nhiệt",
  rescueSymptomElectrical: "Hệ thống điện hỏng",
  rescueSymptomBrakeFail: "Phanh không hoạt động",
  rescueSymptomAccident: "Tai nạn va chạm",
  rescueSymptomStuck: "Xe bị kẹt/sa lầy",
  rescueSymptomLostKey: "Mất chìa khóa",
  rescueSymptomLockJam: "Khóa xe bị kẹt",
