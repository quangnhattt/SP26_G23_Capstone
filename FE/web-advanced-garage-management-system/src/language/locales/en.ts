export default {
  ...
  rescueIssueTitleLabel: "Request title",
  rescueIssueTitlePlaceholder: "E.g: Car broke down on the road",
  rescueIssueDescLabel: "Detailed description",
  rescueIssueDescPlaceholder: "Describe in detail your vehicle's condition...",
  rescueSymptomLabel: "Symptoms (select multiple if applicable)",
  rescueSymptomEngineDead: "Engine dead",
  rescueSymptomOutOfFuel: "Out of fuel",
  rescueSymptomFlatTire: "Flat/blown tire",
  rescueSymptomOverheat: "Engine overheating",
  rescueSymptomElectrical: "Electrical system failure",
  rescueSymptomBrakeFail: "Brake not working",
  rescueSymptomAccident: "Collision accident",
  rescueSymptomStuck: "Vehicle stuck/bogged",
  rescueSymptomLostKey: "Lost key",
  rescueSymptomLockJam: "Lock jammed",
