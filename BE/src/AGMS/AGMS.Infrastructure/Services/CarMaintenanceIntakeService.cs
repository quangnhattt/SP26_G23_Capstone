...
namespace AGMS.Infrastructure.Services
{
    public class CarMaintenanceIntakeService : ICarMaintenanceIntakeService
    {
        ...
        {
            return await _repository.GetIntakesAsync(query, currentUserId, currentRoleId, ct);
        }
        ...
        {
            return await _repository.FinalizeIntakeAsync(maintenanceId, updatedByUserId, ct);
        }
    }
}
