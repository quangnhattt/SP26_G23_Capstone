...
public partial class User
{
    ...
    public virtual ICollection<Transfer_Order> Transfer_OrderApprovedByNavigations { get; set; } = new List<Transfer_Order>();

    public virtual ICollection<Transfer_Order> Transfer_OrderCreateByNavigations { get; set; } = new List<Transfer_Order>();
